...
import Adapter_classes.Adapter_HodComplaintStatus;
import Data_classes.Complaint_card_model;

public class HodComplaintStatus extends AppCompatActivity {
    RecyclerView recyclerView;
    DatabaseReference database;
    Adapter_HodComplaintStatus adapter_hodComplaintStatus;
    ArrayList<Complaint_card_model> list;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.hodcomplaintstatus);

        recyclerView=findViewById(R.id.rclview_hodcomplaintstatus);
...
//                    if (ccm.getY() == 1){
                    ...
                    Adapter_HodComplaintStatus complaint_adapter=new Adapter_HodComplaintStatus(HodComplaintStatus.this,list);
